...
function rowToFleetEntry(row: FleetRow): FleetListEntry {
  ...
  return {
    ...
    decision: {
      ...
      best_action: (row.best_action ?? row.recommended_action ?? recommended) as string,
      mean_cost: meanCost,
      mean_total_cost: Number(row.mean_total_cost ?? row.best_mean_cost ?? meanCost),
      timestamp: ts,
      route,
      all_actions: allActions,
      continue_mean_total: row.continue_mean_total != null ? Number(row.continue_mean_total) : undefined,
      reroute_mean_total: row.reroute_mean_total != null ? Number(row.reroute_mean_total) : undefined,
      detour_mean_total: row.detour_mean_total != null ? Number(row.detour_mean_total) : undefined,
      ...
      diff_env_cost_2: (row as Record<string, unknown>).diff_env_cost_2 != null ? Number((row as Record<string, unknown>).diff_env_cost_2) : undefined,
      // Max/min env from DB (compute diff = max - min)
      max_total_env_cost: (row as Record<string, unknown>).max_total_env_cost != null ? Number((row as Record<string, unknown>).max_total_env_cost) : undefined,
      min_total_env_cost: (row as Record<string, unknown>).min_total_env_cost != null ? Number((row as Record<string, unknown>).min_total_env_cost) : undefined,
      max_environmental_value: (row as Record<string, unknown>).max_environmental_value != null ? Number((row as Record<string, unknown>).max_environmental_value) : undefined,
      min_environmental_value: (row as Record<string, unknown>).min_environmental_value != null ? Number((row as Record<string, unknown>).min_environmental_value) : undefined,
      max_env_spoilage_cost: (row as Record<string, unknown>).max_env_spoilage_cost != null ? Number((row as Record<string, unknown>).max_env_spoilage_cost) : undefined,
      min_env_spoilage_cost: (row as Record<string, unknown>).min_env_spoilage_cost != null ? Number((row as Record<string, unknown>).min_env_spoilage_cost) : undefined,
      // Per-action env (for compute-env-diffs)
      continue_environmental_value: (row as Record<string, unknown>).continue_environmental_value != null ? Number((row as Record<string, unknown>).continue_environmental_value) : undefined,
      reroute_environmental_value: (row as Record<string, unknown>).reroute_environmental_value != null ? Number((row as Record<string, unknown>).reroute_environmental_value) : undefined,
      detour_environmental_value: (row as Record<string, unknown>).detour_environmental_value != null ? Number((row as Record<string, unknown>).detour_environmental_value) : undefined,
      continue_env_spoilage_cost: (row as Record<string, unknown>).continue_env_spoilage_cost != null ? Number((row as Record<string, unknown>).continue_env_spoilage_cost) : undefined,
      reroute_env_spoilage_cost: (row as Record<string, unknown>).reroute_env_spoilage_cost != null ? Number((row as Record<string, unknown>).reroute_env_spoilage_cost) : undefined,
      detour_env_spoilage_cost: (row as Record<string, unknown>).detour_env_spoilage_cost != null ? Number((row as Record<string, unknown>).detour_env_spoilage_cost) : undefined,
      continue_total_env_cost: (row as Record<string, unknown>).continue_total_env_cost != null ? Number((row as Record<string, unknown>).continue_total_env_cost) : undefined,
      reroute_total_env_cost: (row as Record<string, unknown>).reroute_total_env_cost != null ? Number((row as Record<string, unknown>).reroute_total_env_cost) : undefined,
      detour_total_env_cost: (row as Record<string, unknown>).detour_total_env_cost != null ? Number((row as Record<string, unknown>).detour_total_env_cost) : undefined,
